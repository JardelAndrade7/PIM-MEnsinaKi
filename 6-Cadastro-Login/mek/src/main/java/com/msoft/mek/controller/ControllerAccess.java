...
public class ControllerAccess {
    ...
    @GetMapping("/")
    public ModelAndView seeUserFeed (HttpSession http, HttpServletResponse httpServlet) {
    ...
    public ModelAndView tryLogin() {
        ...
        String loginDTOName = "DTOLogin";
        modelAndView.setViewName(viewName);
        modelAndView.addObject(loginDTOName, DTOLogin);
        return modelAndView;
    }

    @PostMapping("/accessEnterLogin")
    public ModelAndView enterLogin (@Valid DTOLogin DTOLogin, BindingResult binding,
                                   HttpSession http, HttpServletResponse httpServlet)
    ...
    public ModelAndView logout(HttpSession http, HttpServletResponse response) {
        http.invalidate();
