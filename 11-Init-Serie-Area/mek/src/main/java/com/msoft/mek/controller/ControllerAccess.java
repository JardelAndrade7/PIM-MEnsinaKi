...
public class ControllerAccess {
    ...
    @Autowired RepositoryAluno repositoryAluno;
    ...
    public ModelAndView seeUserFeed (HttpSession http, HttpServletResponse httpServlet, ModelAndView modelAndView) {
        ...
        if(userLogado == null) {
            ...
            if (userLogadoClassNameTrue) {
                ...
                String modelTutorFeed = "redirect:/solicitacao/readByArea/" + areaId;
                ...
                Long areaId = modelArea.getAreaId();
                String modelAlunoFeed = "redirect:/sugestao/readByArea/" + areaId;
