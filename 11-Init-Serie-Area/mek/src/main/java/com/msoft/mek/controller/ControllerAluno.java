...
import com.msoft.mek.general.DTOAluno;
...
public class ControllerAluno {
    ...
    public ModelAndView saveUpdate (@Valid DTOAluno updating, BindingResult binding, ModelAndView modelAndView) throws Exception {
